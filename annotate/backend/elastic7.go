...
func (e *Elastic7) InsertAnnotation(a *annotate.Annotation) error {
    ...
    _, err := e.Index().Index(e.index).BodyJson(a).Id(a.Id).Do(context.Background())
    return err
}
...
func (e *Elastic7) GetAnnotation(id string) (*annotate.Annotation, bool, error) {
    ...
    res, err := e.Get().Index(e.index).Id(id).Do(context.Background())
    // Ewwww...
...
func (e *Elastic7) DeleteAnnotation(id string) error {
    ...
    _, err := e.Delete().Index(e.index).Id(id).Do(context.Background())
    if err != nil {
        return err
    }
    return nil
