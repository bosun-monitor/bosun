...
// SlackColor returns a color string that corresponds to Slack's colors
// based on the Status of of the embedded IncidentState
func (c *Context) SlackColor() string {
