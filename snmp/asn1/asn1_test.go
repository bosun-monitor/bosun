...
var tagAndLengthData = []tagAndLengthTest{
	...
	// Superfluous zeros in the length are technically invalid, but are still parsable.
	{[]byte{0x00, 0x82, 0x00, 0x01}, true, tagAndLength{0, 0, 1, false}},
	// Zero length should be an error
	{[]byte{0xa0, 0x82, 0x00, 0x00}, false, tagAndLength{}},
